    ...
    Class.prototype.view = function () {
        ...
        var index = config.pages > groups
            ...
            , views = {
                ...
                //数据总数
                , count: '<span class="layui-laypage-count">Of ' + config.count + ' Page/s</span>'
                ...
                //跳页区域
                , skip: function () {
                    return ['<span class="layui-laypage-skip">Turn to page '
                        , '<input type="text" min="1" value="' + config.curr + '" class="layui-input">'
                        , '<button type="button" class="layui-laypage-btn">Jump</button>'
                        , '</span>'].join('');
                }()
            };
